...
const MoviesPage = () => {
  ...
  const fetchMovie = async () => {
    try {
      await axios
        .get(
          "https://popcornspotbackend-production.up.railway.app/movie/getallmovie",
          {
  ...
  const handleDelete = async (_id, title) => {
    ...
    try {
      await axios
        .delete(
          `https://popcornspotbackend-production.up.railway.app/movie/delete/?_id=${_id}`,
          {
            headers: { Authorization: `Bearer ${authToken}` },
          }
        )
              ...
              <div className="space-y-8">
                {movies.map((movie) => (
                  ...
                  >
                    <img
                      src={
                        "https://popcornspotbackend-production.up.railway.app/upload/" +
                        movie.fileName
                      }
